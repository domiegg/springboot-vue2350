...
public class OutboundRecords implements Serializable {
    ...
    // OutboundRecords编号
    @TableId(value = "outbound_records_id", type = IdType.AUTO)
    private Integer outbound_records_id;
    ...
    // 出库用途
    @TableField(value = "`warehousing_purpose`")
    private String warehousing_purpose;
