                ...
                <form class="layui-form" action="">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" name="title" lay-verify="title" autocomplete="off"
                                                       ...
                                                       class="layui-input" id="bookable_location">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" class="layui-input" id="time_of_appointment"
                                                       placeholder="yyyy-MM-dd">
                                            </div>
                                        </div>
                                    </div>
                                                                                                    <div class="layui-form-item" id="number_of_appointments_box">
                                        <label class="layui-form-label">预约数量</label>
                                        <div class="layui-input-block">
                                            <select name="interest" lay-filter="number_of_appointments" id="number_of_appointments">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                                ...
                                                <div class="layui-input-block">
                                                    <select name="interest" lay-filter="user_name"
                                                            id="user_name">
                                                        <option value=""></option>
                                                    </select>
                                                </div>
...
<script>
    var BaseUrl = baseUrl()
    let appointment_record_id = location.search.substring(1)
    layui.use(['upload', 'element', 'layer', 'laydate', 'layedit'], function () {
        ...
        // 提交按钮校验权限
        // if (   user_group == "管理员" ||$check_action('/appointment_record/view', 'add') || $check_action('/appointment_record/view', 'set')) {
        //    submit.style.display = "block"
        // }
        // style="display: none"

        
            let field = "appointment_record_id";
            let url_add = "appointment_record";
            let url_set = "appointment_record";
            let url_get_obj = "appointment_record";
            let url_upload = "appointment_record"
            let query = {
                "appointment_record_id": 0,
            }
            ...
            let form_data2 = {
                            ...
                            "number_of_appointments":  '', // 预约数量
                                "user_name": 0, // 用户姓名
                            "telephone":  '', // 电话
                                    "appointment_record_id": 0, // ID
                                            }

            layui.layedit.set({
      uploadImage: {
        url: BaseUrl + '/api/appointment_record/upload?' //接口url
        , type: 'post' //默认post
      }
    });
            ...
            function $check_field(action, field) {
                var o = $get_power("/appointment_record/view");
                var auth;
                if (o && o[action] != 0 && o[action] != false) {
                    auth = o["field_" + action];
                }
                ...
                return false;
                    ...
                    if ($check_field('add', 'time_of_appointment')){
                        ...
                        $("#time_of_appointment_box").hide()
                            ...
                            if (user_group === '管理员') {
                    $("#number_of_appointments_box").show()
                } else {
                    if ($check_field('add', 'number_of_appointments')){
                        $("#number_of_appointments_box").show()
                    }else {
                        $("#number_of_appointments_box").hide()
                    }
                }
                            if (user_group === '管理员') {
                    $("#user_name_box").show()
                    ...
                    let number_of_appointments_data = ['1'];
                                    ...
                                    laydate.render({
                        elem: '#time_of_appointment'
                        , type: 'datetime'
                        , done: function (value) {
                            console.log(value)
                            form_data2.time_of_appointment = value
                        }
                    });
                        ...
                        for (var i = 0; i < arr.length; i++) {
                            ...
                            if (form_data2.number_of_appointments==arr[i].number_of_appointments){
                                op.selected = true
                            }
                    ...
                    layui.form.on('select(number_of_appointments)', function (data) {
                        form_data2.number_of_appointments = data.elem[data.elem.selectedIndex].text;
                    })
                    ...
                    //文本
                                                                                //文本
                    let bookable_location = document.querySelector("#bookable_location")
                        bookable_location.onkeyup = function (event) {
                        form_data2.bookable_location = event.target.value
                    }
                    //文本
                                                                                                                                                                                                                    //文本
                        ...
                        if (key === dbKey) {
                            if (key!=='examine_state' && key!=='examine_reply'){
                                ...
                                $('#' + key).attr('disabled', 'disabled')
                                            ...
                                            if (key == 'number_of_appointments') {
                                                let alls = document.querySelector('#number_of_appointments').querySelectorAll('option')
                                                let test = form_data2[key]
                                                for (let i = 0; i < alls.length; i++) {
                                                    if (alls[i].innerHTML == test) {
                                                        alls[i].selected = true
                                                        form_data2.number_of_appointments = alls[i].text
                                                        layui.form.render("select");
                                                    }
                                                }
                                            }
            ...
            if (appointment_record_id !== '') {
                async function axios_get_3() {
                    const {data: rese} = await axios.get(BaseUrl + '/api/appointment_record/get_obj', {
                        params: {
                    ...
                    Object.keys(form_data2).forEach((key) => {
                        ...
                        $("#"+key).val(form_data2[key])
                            ...
                            if ($check_field('set', 'number_of_appointments') || $check_field('get', 'number_of_appointments')){
                                $("#number_of_appointments_box").show()
                            }else {
                                $("#number_of_appointments_box").hide()
                            }
                    ...
                    // Array.prototype.slice.call(document.getElementsByTagName('textarea')).map(i => i.disabled = true)
                            ...
                            //文本
                                ...
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'appointment_number')) || (!form_data2['appointment_record_id'] && $check_field('add', 'appointment_number'))) {
                            }else {
                            ...
                            //文本
                                ...
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'vaccine_no')) || (!form_data2['appointment_record_id'] && $check_field('add', 'vaccine_no'))) {
                            }else {
                            ...
                            //文本
                                ...
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'vaccine_name')) || (!form_data2['appointment_record_id'] && $check_field('add', 'vaccine_name'))) {
                            }else {
                            ...
                            //文本
                                ...
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'vaccine_classification')) || (!form_data2['appointment_record_id'] && $check_field('add', 'vaccine_classification'))) {
                            }else {
                            ...
                            //文本
                                ...
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'suitable_for_people')) || (!form_data2['appointment_record_id'] && $check_field('add', 'suitable_for_people'))) {
                            }else {
                                $("#suitable_for_people").attr("disabled", true);
                                $("#suitable_for_people > input[name='file']").attr('disabled', true);
                            }
                                                        //文本
                                bookable_location.value = form_data2.bookable_location
                            //文本
                                
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'bookable_location')) || (!form_data2['appointment_record_id'] && $check_field('add', 'bookable_location'))) {
                            }else {
                                $("#bookable_location").attr("disabled", true);
                                $("#bookable_location > input[name='file']").attr('disabled', true);
                            }
                                    
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'time_of_appointment')) || (!form_data2['appointment_record_id'] && $check_field('add', 'time_of_appointment'))) {
                            }else {
                                $("#time_of_appointment").attr("disabled", true);
                                $("#time_of_appointment > input[name='file']").attr('disabled', true);
                            }
                                    
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'number_of_appointments')) || (!form_data2['appointment_record_id'] && $check_field('add', 'number_of_appointments'))) {
                            }else {
                                $("#number_of_appointments").attr("disabled", true);
                                $("#number_of_appointments > input[name='file']").attr('disabled', true);
                            }
                                    
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'user_name')) || (!form_data2['appointment_record_id'] && $check_field('add', 'user_name'))) {
                            }else {
                            ...
                            //文本
                                ...
                                if (user_group === '管理员' || (form_data2['appointment_record_id'] && $check_field('set', 'telephone')) || (!form_data2['appointment_record_id'] && $check_field('add', 'telephone'))) {
                            }else {
                                $("#telephone").attr("disabled", true);
                                $("#telephone > input[name='file']").attr('disabled', true);
                            }
                                                                                                                                                                                                                                                                            time_of_appointment.value = layui.util.toDateString(form_data2.time_of_appointment, "yyyy-MM-dd HH:mm:ss")
                                                                                                                                                                        layui.form.render("select");
                }
                axios_get_3()
            }
            ...
            submit.onclick = async function () {
                try {
                            ...
                            //文本
                                                                    //文本
                            form_data2.bookable_location = bookable_location.value
                            //文本
                                                                form_data2.time_of_appointment = layui.util.toDateString(form_data2.time_of_appointment, "yyyy-MM-dd HH:mm:ss")
                                                                                                                                    //文本
                ...
                let customize_field = []
                            ...
                            "field_name": "预约时间",
                            "field_value": form_data2.time_of_appointment,
                            "type": "datetime"
                        });
                                                customize_field.push({"field_name": "预约数量", "field_value": form_data2.number_of_appointments});
                ...
                if (appointment_record_id == '') {
                                        console.log("新增/Add")
                    const {data: res} = await axios.post(BaseUrl + '/api/appointment_record/add?',
                            form_data2, {
                                headers: {
                                    'x-auth-token': token,
              ...
              layer.msg(res.error.message);
                    ...
                    const {data: res} = await axios.post(BaseUrl + '/api/appointment_record/set?appointment_record_id=' + appointment_record_id,
                            form_data2, {
                                headers: {
                                    'x-auth-token': token,
                                    'Content-Type': 'application/json'
