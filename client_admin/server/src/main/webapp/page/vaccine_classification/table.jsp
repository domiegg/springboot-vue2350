...
<div class="section1">
    ...
    <div class="table">
        <table class="layui-hide" id="vaccine_classification" lay-filter="vaccine_classification"></table>
...
<script src="../../js/axios.min.js"></script>
    ...
    layui.use(['element', 'layer', 'util'], function () {
        ...
        let url = BaseUrl + '/api/vaccine_classification/get_list?like=0'
        ...
        if (user_group == "管理员" || $check_action('/vaccine_classification/table', 'del') || $check_action('/vaccine_classification/view', 'del')) {
            deletes.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/vaccine_classification/table', 'add') || $check_action('/vaccine_classification/view', 'add')) {
            add.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/vaccine_classification/view', 'get') || $check_action('/vaccine_classification/view', 'set')) {
            detail_flag = true;
        }
    ...
    ,
        parseData: function (res) {
            ...
            if (user_group == "管理员" || $check_pay('/vaccine_classification/table')) {
                for (var i = 0; i < res.result.list.length; i++) {
                    res.result.list[i].check_pay = true
                }
            }
            if (user_group == "管理员" || $check_action('/vaccine_classification/view', 'set') || $check_action('/vaccine_classification/view', 'get')) {
                for (var i = 0; i < res.result.list.length; i++) {
    ...
    ,
        ...
        table.on('tool(vaccine_classification)', function (obj) {
            var data = obj.data;
        if (obj.event === 'detail')
        {

                            window.location.href = "./view_add.jsp?" + data.vaccine_classification_id;
                    }
        ...
        let resetSelect = []
        //下拉框重置/Reset参数
        fun('vaccine_classification', BaseUrl + '/api/vaccine_classification/del', 'vaccine_classification_id', request, resetName, resetSelect        )
