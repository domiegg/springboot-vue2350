...
<div class="section1">
    ...
    <div class="table">
        <table class="layui-hide" id="appointment_cancellation" lay-filter="appointment_cancellation"></table>
...
<script src="../../js/axios.min.js"></script>
    ...
    layui.use(['element', 'layer', 'util'], function () {
        ...
        let url = BaseUrl + '/api/appointment_cancellation/get_list?like=0'
        ...
        if (user_group == "管理员" || $check_action('/appointment_cancellation/table', 'del') || $check_action('/appointment_cancellation/view', 'del')) {
        ...
        if (user_group == "管理员" || $check_action('/appointment_cancellation/view', 'get') || $check_action('/appointment_cancellation/view', 'set')) {
            detail_flag = true;
        }
    ...
    table.render({
        ...
        , cols: [[
                ...
                field: 'time_of_appointment', width: 180, title: '预约时间', sort: true
                                ...
                                , {
                field: 'cancel_quantity', width: 180, title: '取消数量', sort: true
                ...
                field: 'telephone', width: 180, title: '电话', sort: true
                                ...
                                , {
                field: 'reason_for_cancellation', width: 180, title: '取消原因', sort: true
            ...
            if (res.count == null) { // 无数据时直接返回了
                return;
                        ...
                        $("[data-field='time_of_appointment']").css('display', 'none');
                                        ...
                                        if (user_group === '管理员' || $check_field('get', 'cancel_quantity', path1)) {
                        // console.log("显示")
                    } else {
                        $("[data-field='cancel_quantity']").css('display', 'none');
                    }
                        ...
                        $("[data-field='telephone']").css('display', 'none');
                                        ...
                                        if (user_group === '管理员' || $check_field('get', 'reason_for_cancellation', path1)) {
                        // console.log("显示")
                    } else {
                        $("[data-field='reason_for_cancellation']").css('display', 'none');
                    }
    ...
    ,
        parseData: function (res) {
            ...
            if (user_group == "管理员" || $check_pay('/appointment_cancellation/table')) {
                for (var i = 0; i < res.result.list.length; i++) {
                    res.result.list[i].check_pay = true
                }
            }
            if (user_group == "管理员" || $check_action('/appointment_cancellation/view', 'set') || $check_action('/appointment_cancellation/view', 'get')) {
                for (var i = 0; i < res.result.list.length; i++) {
    ...
    ,
        ...
        table.on('tool(appointment_cancellation)', function (obj) {
            var data = obj.data;
        if (obj.event === 'detail')
        {

                            window.location.href = "./view_add.jsp?" + data.appointment_cancellation_id;
                    }
        ...
        //下拉框
                ...
                layui.form.on('select(cancel_quantity)', function (data) {
                    request.cancel_quantity = data.elem[data.elem.selectedIndex].text;
                })
                    cancel_quantity()
        ...
        let resetSelect = []
        //下拉框重置/Reset参数
        fun('appointment_cancellation', BaseUrl + '/api/appointment_cancellation/del', 'appointment_cancellation_id', request, resetName, resetSelect        )
