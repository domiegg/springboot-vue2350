...
<div class="section1">
    ...
    <div class="table">
        <table class="layui-hide" id="vaccination_personnel" lay-filter="vaccination_personnel"></table>
...
<script src="../../js/axios.min.js"></script>
    ...
    layui.use(['element', 'layer', 'util'], function () {
        ...
        let url = BaseUrl + '/api/vaccination_personnel/get_list?like=0'
        ...
        if (user_group == "管理员" || $check_action('/vaccination_personnel/table', 'del') || $check_action('/vaccination_personnel/view', 'del')) {
            deletes.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/vaccination_personnel/table', 'add') || $check_action('/vaccination_personnel/view', 'add')) {
            add.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/vaccination_personnel/view', 'get') || $check_action('/vaccination_personnel/view', 'set')) {
            detail_flag = true;
        }
        ...
        function getpath() {
            ...
            for (var i = 0; i < list_data.length; i++) {
                var o = list_data[i];
                if (o.path === "/vaccination_personnel/table") {
                    console.log(o.path);
                    path1 = o.path
                        $get_power(o.path)
                }
    ...
    ,
        parseData: function (res) {
            ...
            if (user_group == "管理员" || $check_pay('/vaccination_personnel/table')) {
                for (var i = 0; i < res.result.list.length; i++) {
                    res.result.list[i].check_pay = true
                }
            }
            if (user_group == "管理员" || $check_action('/vaccination_personnel/view', 'set') || $check_action('/vaccination_personnel/view', 'get')) {
                for (var i = 0; i < res.result.list.length; i++) {
    ...
    ,
        ...
        table.on('tool(vaccination_personnel)', function (obj) {
            var data = obj.data;
        if (obj.event === 'detail')
        {
        ...
        let resetSelect = []
        //下拉框重置/Reset参数
        fun('vaccination_personnel', BaseUrl + '/api/vaccination_personnel/del', 'vaccination_personnel_id', request, resetName, resetSelect                        , undefined, undefined,true
        )
